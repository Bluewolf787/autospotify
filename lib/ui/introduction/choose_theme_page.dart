                ...
                child: FittedBox(
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: [
                        TextSpan(
                          text: AppLocalizations.of(context)!.chooseThemeSpan1,
                        ),
                        TextSpan(
                        ...
                        TextSpan(
                          text: AppLocalizations.of(context)!.chooseThemeSpanFr,
                        ),
                        TextSpan(
                          text: '.',
                          style: TextStyle(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextButton.icon(
                      onPressed: () =>
                          ButtonPressedHandler().changeThemeButton(context),
                      label: Text(
            ...
            Positioned(
              ...
              child: CustomBackButton(
                onPressed: () => {
                  ...
                  Navigator.of(context).pushReplacement(PageTransition(
                      child: IntroStartPage(), type: PageTransitionType.fade))
                },
              ),
            ),
